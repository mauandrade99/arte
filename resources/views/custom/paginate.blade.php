@if ($paginator->hasPages())
    <ul class="pagination">
        ...
        @if ($paginator->onFirstPage())
            <li class="disabled hide"><i class="material-icons">chevron_left</i></li>
        @else
        ...
        @foreach ($elements as $element)
            ...
            @if (is_string($element))
                <li class="disabled hide">{{ $element }}</li>
            @endif
        ...
        @else
            <li class="disabled hide"><a href="{{ $paginator->nextPageUrl() }}"><i class="material-icons">chevron_right</i></a></li>
        @endif
    </ul>
@endif
